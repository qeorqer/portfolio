export const workExperience = [
  ...
  },
  {
    ...
    description:
      'Started my corporate career here, worked in a small team with talanted and more experienced developers. My job was to create front end and backend of educational platform.',
